...
** DESCRIPTION:	CViewDlg class definition.
**
*******************************************************************************
*/
...
** Description:	.
**
** Parameters:	iRscID		The ID of the dialog template resource.
**
** Returns:		Nothing.
**
*******************************************************************************
...
** Method:		OnUIUpdate()
**
** Description:	Default update UI handler.
**
** Parameters:	None.
**
** Returns:		Nothing.
