	...
	, m_ebCredit(false, 6, 2)
{
	...
	DEFINE_CTRLMSG_TABLE
		CMD_CTRLMSG(IDC_NO_CREDIT,			BN_CLICKED, &CIncomePage::OnNoCredit  )
		CMD_CTRLMSG(IDC_FIXED_CREDIT,		BN_CLICKED, &CIncomePage::OnFxdCredit )
		CMD_CTRLMSG(IDC_VARIABLE_CREDIT,	BN_CLICKED, &CIncomePage::OnVarCredit )
		CMD_CTRLMSG(IDC_ADD_CREDIT,			BN_CLICKED, &CIncomePage::OnAddCredit )
		CMD_CTRLMSG(IDC_EDIT_CREDIT,		BN_CLICKED, &CIncomePage::OnEditCredit)
		CMD_CTRLMSG(IDC_DEL_CREDIT,			BN_CLICKED, &CIncomePage::OnDelCredit )
		NFY_CTRLMSG(IDC_CREDITS,			NM_DBLCLK,  &CIncomePage::OnDblClick )
	END_CTRLMSG_TABLE
}
