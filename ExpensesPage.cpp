	...
	, m_ebDebit(false, 6, 2)
{
	...
	DEFINE_CTRLMSG_TABLE
		CMD_CTRLMSG(IDC_NO_DEBIT,			BN_CLICKED, &CExpensesPage::OnNoDebit  )
		CMD_CTRLMSG(IDC_FIXED_DEBIT,		BN_CLICKED, &CExpensesPage::OnFxdDebit )
		CMD_CTRLMSG(IDC_VARIABLE_DEBIT,		BN_CLICKED, &CExpensesPage::OnVarDebit )
		CMD_CTRLMSG(IDC_ADD_DEBIT,			BN_CLICKED, &CExpensesPage::OnAddDebit )
		CMD_CTRLMSG(IDC_EDIT_DEBIT,			BN_CLICKED, &CExpensesPage::OnEditDebit)
		CMD_CTRLMSG(IDC_DEL_DEBIT,			BN_CLICKED, &CExpensesPage::OnDelDebit )
		NFY_CTRLMSG(IDC_DEBITS,				NM_DBLCLK,  &CExpensesPage::OnDblClick )
	END_CTRLMSG_TABLE
}
