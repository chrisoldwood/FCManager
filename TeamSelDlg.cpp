	...
	, m_nFormation(0)
{
	...
	DEFINE_CTRLMSG_TABLE
		CMD_CTRLMSG(IDC_TEAM_FILTER,     CBN_SELCHANGE, &CTeamSelDlg::OnSelectTeamFilter)
		CMD_CTRLMSG(IDC_POSITION_FILTER, CBN_SELCHANGE, &CTeamSelDlg::OnSelectPosFilter)
		CMD_CTRLMSG(IDC_PLAYER,          LBN_SELCHANGE, &CTeamSelDlg::OnSelectPlayer)
		CMD_CTRLMSG(IDC_FORMATION,       CBN_SELCHANGE, &CTeamSelDlg::OnSelectFormation)
		CMD_CTRLMSG(IDC_NOTES,           BN_CLICKED,	&CTeamSelDlg::OnNotes)
	END_CTRLMSG_TABLE
}
