	...
	, m_ebBalance(true, 6, 2)
{
	...
	DEFINE_CTRLMSG_TABLE
		CMD_CTRLMSG(IDC_FIXED,		BN_CLICKED, &CAccountPage::OnFixed    )
		CMD_CTRLMSG(IDC_VARIABLE,	BN_CLICKED, &CAccountPage::OnVariable )
		CMD_CTRLMSG(IDC_ADD,		BN_CLICKED, &CAccountPage::OnAddTrans )
		CMD_CTRLMSG(IDC_EDIT,		BN_CLICKED, &CAccountPage::OnEditTrans)
		CMD_CTRLMSG(IDC_DEL,		BN_CLICKED, &CAccountPage::OnDelTrans )
		NFY_CTRLMSG(IDC_TRANS,		NM_DBLCLK,  &CAccountPage::OnDblClick )
	END_CTRLMSG_TABLE
}
